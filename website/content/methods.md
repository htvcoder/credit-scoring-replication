...
Website hiện mô tả phương pháp ở mức kế hoạch và trạng thái nghiệm thu kỹ thuật. Phase 6 đã hoàn thành MLP infrastructure/hardening; GC/TC reduced runs là non-publishable engineering validation. P7C.1, P7C.2.1 và P7C.2.2 đã completed; pilot RF/XGBoost 60/60 fit đã validate. P7C.2.3 đã khóa full P7A/Table-2 grids RF 30 candidates và XGBoost 108 candidates. P7C.3 đang In Progress: immutable MLP feasibility plan/runner execution-ready với CPU policy khóa nhưng 60 fits NOT RUN, nên chưa có runtime/RSS/projection hay CPU/GPU decision. Chưa có scientific execution hoặc kết quả nghiên cứu chính thức.
...
- P7C.1 inventory/readiness, P7C.2.1 immutable 60-fit RF/XGBoost engineering harness, P7C.2.2 research pilot và P7C.2.3 protocol decision đã completed. Pilot là engineering evidence non-publishable; không dùng predictive metric/ranking để giảm grid. P7C.3 MLP scope/budget decision đang In Progress với execution-ready preregistered plan, CPU-only sequential/two-thread policy and NOT RUN 60-fit workload; runtime/RSS/projection and final scope/budget remain outstanding. CART/RF/XGBoost locks không tự động khóa budget/search space của model khác.
