...
P7C.4 overall vẫn in progress. P7C.4B.2a đã khóa proposed scientific scope tại `configs/protocols/p7c/p7c4b2a_mlp_scientific_manifest.yaml`: DR-P7C-03 chọn balanced subset 24/48/48 và DR-P7C-04 giữ MLP-5. Đây là reduced deterministic subset, không equivalent exhaustive Table-2 search. P7C.4B.2b executable bounded-preflight harness đã sẵn sàng và được fixture-validate, nhưng target compute feasibility, canonical mode, runtime/cost và canonical execution vẫn pending/NO-GO; phải thu thập target single-VM preflight trước mọi quyết định execution/GPU/multi-VM.
